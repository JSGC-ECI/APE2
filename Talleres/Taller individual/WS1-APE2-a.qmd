...
8. (a) Find the 90th percentile of $Z \sim \mathcal N(0,1)$, i.e., compute $z_{0.90}$ such that $P(Z \le z_{0.90})=0.90$.
...
12. (a) For $Z \sim \mathcal N(0,1)$, compute $z_\alpha$ such that $P(|Z| \le z_\alpha) = 0.99$.
